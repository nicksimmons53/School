...
void printTraversal(Graph graph, int iCourseVertex, int indent);						//tae015
void printLongChains(Graph graph, int iVertex, int pathM[], int iLevel, int iLongLength);
int causesCycle(Graph graph, int iPrereqVertex, int iVertex);							//tae015
...
void printSources(Graph graph);															//tae015
void printSinks(Graph graph);															//tae015
